...
(function () {
  const DICT = {
    ro: {
      ...
      'footer.company1': 'Contact', 'footer.company2': 'Întrebări frecvente',
      ...
      'promo.tag': 'Nou în magazin',
      'promo.title': 'Stația ta de nadă, imprimată 3D și gravată cu numele tău.',
      'promo.sub': 'Bacuri de nadă și suporturi pentru wafters și gel. Logo MiniAnglers gravat gratuit pe fiecare piesă.',
      'promo.cta': 'Cumpără acum',
      ...
      'val.t1': 'Printat 3D la noi', 'val.d1': 'Fabricat la comandă în Timiș.',
      'val.t2': 'Gravare logo gratuită', 'val.d2': 'Inclusă pe orice produs.',
      'val.t3': 'Livrare în România', 'val.d3': 'Ambalat sigur pentru drum.',
      'val.t4': 'Retur în 14 zile', 'val.d4': 'Simplu, fără bătăi de cap.',
    },
    en: {
      'nav.shop': 'Shop',
      ...
      'footer.company1': 'Contact', 'footer.company2': 'FAQ',
      ...
      'promo.tag': 'New in store',
      'promo.title': 'Your bait station, 3D-printed and engraved with your name.',
      'promo.sub': 'Groundbait tubs and holders for wafters and gel. MiniAnglers logo engraved free on every piece.',
      'promo.cta': 'Shop now',
      ...
      'val.t2': 'Free logo engraving', 'val.d2': 'Included on every product.',
      'val.t3': 'Delivery across Romania', 'val.d3': 'Packed safe for the trip.',
      'val.t4': '14-day returns', 'val.d4': 'Simple, no hassle.',
    },
  };
